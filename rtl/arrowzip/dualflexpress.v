...
module	qflashxpress(i_clk, i_reset,
	...
	always @(posedge i_clk)
		if (((i_wb_stb)&&(!o_wb_stall))||(maintenance))
			data_pipe <= { 1'b0, i_wb_addr, 2'b00, 8'ha0 };
		else if (o_dspi_sck == 2'b01)
			data_pipe <= { data_pipe[29:0], 2'h0 };
	assign	o_dspi_dat = (maintenance)? m_dat : data_pipe[31:30];
