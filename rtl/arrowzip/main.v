...
//x2	Was a master bus as well
	assign	      wb_dio_sel = ((wb_addr[21:18] &  4'hf) ==  4'h5); // 0x500000 - 0x50007f
//x2	Was a master bus as well
	assign	       bkram_sel = ((wb_addr[21:18] &  4'hf) ==  4'h6); // 0x600000 - 0x600fff
...
//x2	Was a master bus as well
	...
	begin
		casez({		flashcfg_ack,
			...
			6'b00001?: wb_idata <= wb_dio_data;
			6'b000001: wb_idata <= bkram_data;
