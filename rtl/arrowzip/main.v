...
//
	...
	wire	sdramdbg_int;	// sdramdbg.INT.FLASHDBG.WIRE
...
`include "builddate.v"
	...
	// Wishbone slave definitions for bus wb, slave sdramdbg
	wire		sdramdbg_sel, sdramdbg_ack, sdramdbg_stall;
	wire	[31:0]	sdramdbg_data;
 ...
 // 0x000040 - 0x00005f
	...
	assign	    sdramdbg_sel = ((wb_addr[22:19] &  4'hf) ==  4'h2); // 0x400000 - 0x400007
...
//x2	Was a master bus as well
	assign	      wb_dio_sel = ((wb_addr[22:19] &  4'hf) ==  4'h5); // 0xa00000 - 0xa0007f
//x2	Was a master bus as well
...
`else	// SDRAMSCOPE_SCOPE
	...
	reg	r_sdramdbg_ack;
	initial	r_sdramdbg_ack = 1'b0;
	always @(posedge i_clk)	r_sdramdbg_ack <= (wb_stb)&&(sdramdbg_sel);
	assign	sdramdbg_ack   = r_sdramdbg_ack;
	assign	sdramdbg_stall = 0;
	assign	sdramdbg_data  = 0;
