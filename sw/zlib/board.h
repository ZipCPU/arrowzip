...
static volatile RTCLIGHT *const _rtc = ((RTCLIGHT *)0x00400040);
#endif	// RTC_ACCESS
#ifdef	SPIO_ACCESS
#define	_BOARD_HAS_SPIO
static volatile unsigned *const _spio = ((unsigned *)3145744);
#endif	// SPIO_ACCESS
#define	_BOARD_HAS_BUSERR
static volatile unsigned *const _buserr = ((unsigned *)3145732);
#ifdef	FLASH_ACCESS
...
static volatile unsigned *const _buspic = ((unsigned *)0x00300008);
#endif	// BUSPIC_ACCESS
